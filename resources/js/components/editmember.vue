		...
		<div class="container" style="font-size:40px;color:black;" align="center">
			...
			<div class="div3" >
				...
				<div class="form-group">
					...
					<input type="integer" class="form-control" v-model="order_of_delivery">
				</div>
				<div class="form-group">
					<button style="margin-top:60px;font-size:25px;"  class="btn3 btn-primary" v-on:click="updatemember()">อัปเดตข้อมูล</button>
