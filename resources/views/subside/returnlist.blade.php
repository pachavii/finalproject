                    ...
                    <table style="margin-top:20px !important;" border="1" class="table table-bordered" >
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><input style="background-color:#88ff4d;" onclick="location.href='{{ url('/home') }}'" type="submit" name="" value="submit" class="btn6 btn-success"></td>
                            </tr>
                        </tfoot>
                    </table>
                    <br><br>
                    <a style="margin-top:80px;"  class="btn6 btn-primary" onclick="location.href='{{ url('/home') }}'">back</a>
                </div>
            </div>
        </section>
    </form>
